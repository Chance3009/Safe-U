export const categories = [
  {
    ...
    description: "Learn how to identify, prevent, and respond to harassment situations",
  ...
  },
  {
    ...
    description: "Essential safety tips for walking alone, especially during nighttime",
    icon: "moon",
    color: "#FF9500",
  ...
  },
  {
    ...
    description: "Protect yourself and your belongings from theft and pickpocketing",
    icon: "lock-closed",
    color: "#34C759",
